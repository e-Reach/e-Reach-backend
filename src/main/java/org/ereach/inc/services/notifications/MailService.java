...
public interface MailService {
	...
	ResponseEntity<EReachNotificationResponse> sendMail(String email, String role, String firstName, String path, String lastName) throws RequestInvalidException;
