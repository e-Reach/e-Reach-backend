...
public class Constants {
	...
	public static final String ACTIVATE_HOSPITAL_ACCOUNT = "hospital/activate-account/";
	public static final String ACTIVATE_HOSPITAL_ADMIN_ACCOUNT = "hospital-admin/activate-account/";
